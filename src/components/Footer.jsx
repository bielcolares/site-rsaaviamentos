      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14 mb-10 pb-8 border-b border-white/5">
          ...
          <div className="flex flex-col gap-5">
            <h5 className="font-bold tracking-widest uppercase text-xs text-white/40 mb-2">
              Empresa
            </h5>
            <Link
              href="/"
          ...
          <div className="flex flex-col gap-6 items-start">
            <h5 className="font-bold tracking-widest uppercase text-[10px] text-white/30 mb-2">
              Social
            </h5>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-white/5 hover:bg-white/10 px-8 py-3 rounded-full transition-colors text-[11px] font-bold border border-white/5 uppercase tracking-wider"
            >
              <svg
                width="18"
                height="18"
