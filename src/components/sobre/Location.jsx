    ...
    <section className="w-full bg-white py-24 md:py-32 font-sans border-b border-black/5">
      <div className="container mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-16 lg:gap-20 items-center justify-between">
        ...
        <div className="flex-1 w-full bg-brand-cream/50 rounded-3xl overflow-hidden shadow-lg border border-brand-green-dark/5 min-h-[400px] h-full lg:h-[600px] relative">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1m3!1d3657.4526543166946!2d-46.61453262372481!3d-23.552174361245053!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce592ffc92fa31%3A0xe54dc293fef2a8b9!2sR.%20Dr.%20Carlos%20Botelho%2C%2097%20-%20Br%C3%A1s%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2003017-010!5e0!3m2!1spt-BR!2sbr!4v1700000000000!5m2!1spt-BR!2sbr"
            width="100%"
            height="100%"
